...
function Project(name, infoText, picture) {
	...
	nextImg.setAttribute('src', 'img/foward-arrow.png');
	next.appendChild(nextImg);
	next.style.top = "276px";
	next.style.left = (window.innerWidth * 0.6) - 48 + 'px';
	...
	backImg.setAttribute('src', 'img/back-arrow.png');
...
function writeAbout(){
	...
	new Paragraph("Hello, I am Colton Sandvik, I write websites, plugins, plasmoids, software, and various other things to make my life and others easier!", 1);
}
